...
class FormLomba extends StatefulWidget {
  const FormLomba({super.key});

  @override
  State<FormLomba> createState() => _FormLombaState();
}
...
class _FormLombaState extends State<FormLomba> {
  ...
  TextEditingController kategoriLombaController = TextEditingController();
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormFieldComponent(
                    validationForm: 'Harap Isi Nama Lomba',
                    controllerForm: namaLombaController,
                    hintTextField: 'Masukan Nama Lomba',
                  ...
                  TextFormFieldComponent(
                    validationForm: 'Harap Isi Kategori Lomba',
                    controllerForm: kategoriLombaController,
                    hintTextField: 'Masukan Kategori Lomba',
                    regex: RegExp(r'^[a-zA-Z0-9 !@#$%^&*()-_+=]+$'),
                  ),
                  SizedBox(height: 16),
